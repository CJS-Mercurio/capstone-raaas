...
<div class="container-fluid form">
  <div class="row">
    <div class="col-lg-12 form-col">
      ...
      <form method="post" action="<?= base_url() ?>/profile/change" >
        <div class="row">
          <div class="col-12">
            <div class="form-group">
                <label for="opwd">Enter Old Password</label>
                <input type="password" class="form-control" name="opwd" id="opwd" required>
             </div>
             <div class="form-group">
                <label for="npwd">New Password</label>
                <input type="password" class="form-control" name="npwd" id="npwd" required>
             </div>
             <div class="form-group">
                <label for="cnpwd">Confirm New Password</label>
                <input type="password" class="form-control" name="cnpwd" id="cnpwd" required>
             </div>
              <div class="form-group">
