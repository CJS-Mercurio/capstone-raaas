  ...
  <div class="container-fluid form">
    <div class="row">
        <div class="col-lg-12 form-col">
          <h3>Faculty Seminar/ Training/ Conference Attended</h3>
          ...
          <nav class="navbar navbar-light bg-light">
            <form method="post" action="<?=base_url()?>/student/searchProfSeminar" class="form-inline" >
              <input class="form-control mr-sm-2" type="search" name="prof_name" placeholder="Search" aria-label="Search">
              <button class="btn btn-outline-secondary my-2 my-sm-0" type="submit">Search</button>
            </form>
          </nav>
<!--
          <a href="<?=base_url()?>/student/profSeminarPdf" target="_blank" class="btn btn-success float-right std-researchV mb-3">
            <i class="fa fa-download std-researchV-icon"></i> Download as PDF </a>
          <a href="<?=base_url()?>/student/profSeminarCsv" target="_blank" class="btn btn-success float-right std-researchV mb-3 mr-3">
