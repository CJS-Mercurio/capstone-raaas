  ...
  public function __construct(){
	...
	//seminar reports
	  public function prof_seminar(){
		  ...
		  echo view('Modules\Student\Views\facultyDetails\profSeminarV', $data);
  	...
  	public function prof_published_research(){
  		...
  		echo view('Modules\Student\Views\templates\student_header');
		  echo view('Modules\Student\Views\facultyDetails\profPubResearchV', $data);
		  echo view('Modules\Student\Views\templates\student_footer');
    ...
    public function search_prof_seminar(){
      ...
      echo view('Modules\Student\Views\templates\student_header');
      echo view('Modules\Student\Views\facultyDetails\searchSeminarV', $data);
      echo view('Modules\Student\Views\templates\student_footer');
    ...
    public function search_pub_research(){
      ...
      echo view('Modules\Student\Views\templates\student_header');
      echo view('Modules\Student\Views\facultyDetails\searchPubResearchV', $data);
      echo view('Modules\Student\Views\templates\student_footer');
