...
<div class="container-fluid form">
  <div class="row">
    <div class="col-lg-12 form-col">
      ...
      <form class="register-form" action="<?= base_url() ?>/superadmin/addStudentUser/<?=$role['role_id'];?>" method="post" enctype="multipart/form-data">
        <div class="row">
         ...
         <div class="col-12 col-sm-6">
          ...
          <div class="col-12">
            <div class="form-group">
             <label for="email">Student Number: <span style="color: red; ">*</span></label>
             <div class="input-group">
               <input type="text" class="form-control" name="student_number" id="student_number" placeholder="eg. 2018-00343-TG-0">
             </div>
