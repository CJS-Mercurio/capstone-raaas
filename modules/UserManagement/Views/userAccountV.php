      		...
      		<div class="row">
      			<div class="col-8">
                     ...
                     <?php if(session()->getTempdata('activation_expired') == 'no'): ?>
      					...
      					<h4>Name:</h4><br>
      					   <p><?= ucwords($user['last_name']. ", ". $user['first_name']. " " . $user['middle_name']); ?></p><br>

      					<h4>ID:</h4>
                    <img src="<?=base_url()?>/public/pictures/<?= $user['valid_id'];?>" height="400" width="400">

            				<div class="col">
      							   <form method="post" action="<?=base_url()?>/userManagement/userActivate/<?= $user['id'] ?>">
                ...
                <h4>ID:</h4>
                    ...
                    <div class="col-4">
                      ...
                      <div class="card text-center">
                       <form method="post" action="<?=base_url()?>/admin/delUserExpAcc/<?= $user['id'] ?>">
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <form method="post" action="<?=base_url()?>/userManagement/userDeactivate/<?= $user['id'] ?>">
                       ...
                       <select class="custom-select" id="reason" name="reason">
                                   ...
                                   <option name="reason" value="Mismatch information">Mismatch information</option>
