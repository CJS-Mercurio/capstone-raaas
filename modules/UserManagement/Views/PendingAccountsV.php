              ...
              <?php if($student): ?>
		              <?php foreach($student as $s): ?>
			              ...
			              <tr>
			                 ...
			                 <td>
                         <form method="post" action="<?=base_url()?>/userManagement/studRegistration/<?= $s['id'] ?>">
              ...
              <?php if($professor): ?>
                  <?php foreach($professor as $p): ?>
                    ...
                    <tr>
                       ...
                       <td>
                         <form method="post" action="<?=base_url()?>/userManagement/profRegistration/<?= $p['id'] ?>">
                          <button type="submit" class="btn btn-info">View</button>
                        </form>
                       </td>
                     </tr>
                 ...
                 <?php if($other_role): ?>
                     <?php foreach($other_role as $or): ?>
                       ...
                       <tr>
                          ...
                          <td>
                            <form method="post" action="<?=base_url()?>/userManagement/userRegistration/<?= $or['id'] ?>">
                             <button type="submit" class="btn btn-info">View</button>
                           </form>
                          </td>
                        </tr>
