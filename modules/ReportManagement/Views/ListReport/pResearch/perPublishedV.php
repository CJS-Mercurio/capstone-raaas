  ...
  <div class="container-fluid form">
    <div class="row">
      <div class="col-lg-12 form-col">
        <a href="<?=base_url()?>/profile/perPublishedPDF/<?= $detail['year_start'];?>/<?= $detail['year_end'];?>/<?= $detail['faculty'];?>" target="_blank" class="btn btn-success btn-sm float-right std-researchV-btn mb-3">
          <i class="fa fa-download std-researchV-icon"></i> Download as PDF </a>
        <a href="<?=base_url()?>/profile/perPublishedCSV/<?= $detail['year_start'];?>/<?= $detail['year_end'];?>/<?= $detail['faculty'];?>" class="btn btn-success btn-sm float-right std-researchV-btn mb-3 mr-1">
          <i class="fa fa-download std-researchV-icon"></i> Download as CSV </a>
        <h3><?php echo "List of Published Researches";?></h3>

          <?php if($per_published): ?>
          ...
          <button type="button" class="btn" data-toggle="tooltip" data-placement="top" title="See more">
             ...
             <thead>
               ...
               <tbody>
                  <?php foreach($per_published as $r): ?>
                          <tr>
                            ...
                            <td><?php echo $date; ?></td>
                             <td><a href="<?=$r['institute'] ?>">View here</a></td>
