...
<div class="container-fluid form">
  <div class="row">
    <div class="col-lg-12 form-col">
      <a href="<?=base_url()?>/profile/seminarPDF" target="_blank" class="btn btn-success btn-sm float-right std-researchV-btn mb-3">
        <i class="fa fa-download std-researchV-icon"></i> Download as PDF </a>
      <a href="<?=base_url()?>/profile/seminarCSV" class="btn btn-success btn-sm float-right std-researchV-btn mb-3 mr-1">
           ...
           <thead>
             ...
             <tbody>
                <?php foreach($all_seminar as $r): ?>
                        <tr>
                           <td><?php echo ucwords($r['firstname']. " " .$r['lastname']); ?></td>
