  ...
  <div class="container-fluid">
    <div class="row">
        <div class="col-lg-12 superadmin-form mb-3">
          <div class="header">
            <h3 class="admin-header mb-3">Faculty Seminar/ Training/ Conference Attended</h3>
          </div>
            <a href="<?=base_url()?>/admin/profSeminarPdf" target="_blank" class="btn btn-success float-right std-researchV mb-3">
              <i class="fa fa-download std-researchV-icon"></i> Download as PDF </a>
            <a href="<?=base_url()?>/admin/profSeminarCsv" target="_blank" class="btn btn-success float-right std-researchV mb-3 mr-3">
