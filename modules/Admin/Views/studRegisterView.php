  ...
  <div class="row">
      <div class="col-lg-12 superadmin-form mb-3">
              ...
              <div class="col-md-3 mt-4">
                <b><p><?= $student['student_number']; ?></p></b><br>
                <b><p><?= ucwords($student['last_name']. ", ". $student['first_name']. " " . $student['middle_name']); ?></p></b><br> <br>
                <b><p><?= $course['course_name']. " - ".$student['year']; ?></p></b><br>
              </div>

              <div class="col-md-5">
      					<h4>ID:</h4>
                    <img src="<?=base_url()?>/public/pictures/<?= $student['school_id'];?>" height="400" width="400">
                    <form method="post" action="<?=base_url()?>/admin/studActivate/<?= $student['id'] ?>">
                ...
                <h4>ID:</h4>
                    ...
                    <div class="col-4">
                      ...
                      <div class="card text-center">
                       <form method="post" action="<?=base_url()?>/admin/delStudentExpAcc/<?= $student['id'] ?>">
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <form method="post" action="<?=base_url()?>/admin/studDeactivate/<?= $student['id'] ?>">
