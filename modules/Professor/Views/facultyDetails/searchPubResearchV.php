    ...
    <div class="row">
        <div class="col-lg-12 admin-form mb-3">
          ...
          <nav class="navbar navbar-light bg-light">
            <form method="post" action="<?=base_url()?>/professor/searchPubResearch" class="form-inline">
              <input class="form-control mr-sm-2" name="prof_name" type="search" placeholder="Search" aria-label="Search">
              <button class="btn btn-outline-secondary my-2 my-sm-0" type="submit">Search</button>
            </form>
          </nav>

        <!--   <a href="<?=base_url()?>/professor/profpResearchPdf" target="_blank" class="btn float-right btn-success std-researchV">
            <i class="fa fa-download std-researchV-icon"></i> Download as PDF </a>
          <a href="<?=base_url()?>/professor/profpResearchCsv" target="_blank" class="btn float-right btn-success std-researchV mr-3 mb-3">
