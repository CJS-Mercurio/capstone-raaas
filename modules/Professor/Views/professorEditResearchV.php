...
<div class="container-fluid form">
  <div class="row">
      <div class="col-lg-12 form-col">
        ...
        <form method="post" action="<?=base_url()?>/professor/edit_prof_res/<?=$research['id']?>" enctype="multipart/form-data">
          ...
          <?php if(count($author) > 0): ?>
           <select class="form-control selectpicker authorSelect" multiple data-live-search= "true" name="selectedAuthors[]" id="selectedAuthors">
             <?php foreach($author as $a): ?>
                   <option name="author" value="<?= $a['id']; ?>"> <?= $a['f_firstname']. " " .$a['f_lastname']; ?></option>
        ...
        <hr height="100px" style="margin-top: 70px;">
           ...
           <p>Current file: <?= $research['file']?></p>
            <div class="input-group mb-3">
                ...
                <div class="input-group-append">
                 <input type="submit" class="btn btn-success" name="upload_btn" value="Update">
                </div>
              </div>
            </form>
        ...
        <div class="modal fade" id="exampleModalCenter" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
          <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
              ...
              <form method="post" action="/OrtacFinal/professor/add_panel_edit/<?= $research['id'] ?>">
                 <div class="form-row">
